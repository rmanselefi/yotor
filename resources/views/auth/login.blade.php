    ...
    <div class="auth-pages">
        <div class="auth-left">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <input type="email" class="uk-input uk-form-width-large" id="email" name="email" value="{{ old('email') }}" placeholder="Email" required autofocus>
                <input type="password" class="uk-input uk-form-width-large" id="password" name="password" value="{{ old('password') }}" placeholder="Password" required>
