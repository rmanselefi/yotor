        ...
        <div class="my-profile">
            <div class="uk-card uk-card-default uk-card-small tm-ignore-container">
                  <header class="uk-card-header" style="background-color: white;">
                    <h1 class="uk-h2">Edit Product</h1>
                  </header>
                  <form class="uk-form-stacked" role="form"                           
                            action="{{ route('dashboard.update',$product->id) }}"
                          ...
                          <div class="uk-grid-small uk-child-width-1-1 uk-child-width-1-2@s uk-grid" uk-grid="">
                            <div>
                              <label><div class="uk-form-label">Name</div>
                                <input class="uk-input" type="text" name="name" value="{{$product->name}}" ></label>
                            </div>
                            <div>
                              <label><div class="uk-form-label">Slug</div>
                                <input class="uk-input" type="text" name="slug" value="{{$product->slug}}" ></label>
                            </div>
                            <div>
                              <label><div class="uk-form-label">Details</div>
                                <input class="uk-input" type="text" name="details" value="{{$product->details}}" ></label>
                            </div>
                            <div>
                              <label><div class="uk-form-label">Price</div>
                                <input class="uk-input" type="text" name="price" value="{{$product->price}}" ></label>
                            </div>
                          </div>
                        </fieldset>
                        <fieldset class="uk-fieldset">
                          ...
                          <div class="uk-width-1-1">
                              <label><div class="uk-form-label">Description</div>
                                <textarea class="uk-textarea" rows="5" name="description" placeholder="Description">
                                    {{$product->description}}
                                </textarea>
                              </label>
                            </div>                        
                            ...
                            <div class="uk-width-1-1">
                              <label><div class="uk-form-label">Quantity</div>
                                <input class="uk-input" type="text" name="quantity" value="{{$product->quantity}}"></label>
                            </div>
