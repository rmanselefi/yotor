<ul class="uk-navbar-nav">
    @guest
        <li ><a class="uk-navbar-toggle uk-hidden@m uk-navbar-toggle-icon uk-icon" href="{{ route('register') }}">Sign Up</a></li>
        <li><a href="{{ route('login') }}">Login</a></li>

    @else
        <a class="uk-navbar-item uk-link-muted tm-navbar-button uk-icon" href="account.html" uk-icon="user"
            aria-expanded="false"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="uk-grid-small uk-flex-middle" uk-grid>
                <div class="uk-width-expand">
                    <form action="{{ route('search') }}" method="GET" class="uk-search uk-search-navbar uk-width-1-1">
                        <input class="uk-search-input" name="query" id="query" type="search" placeholder="Search…"
                            value="{{ request()->input('query') }}" autofocus="">
                    </form>
                </div>
