                            ...
                            <ul>
                                @foreach ($products as $product)
                                    <li style="margin-bottom: 10px">
                                        <div style="font-weight: bold;font-size: 15px">Product Id: {{ $product->id }}</div>
                                        <div style="font-weight: bold;font-size: 15px">Product Name: {{ $product->name }}</div>
                                        <div style="font-weight: bold;font-size: 15px">Product Price: {{ $product->presentPrice() }}</div>
                                        <div style="font-weight: bold;font-size: 15px">Product Quantity: {{ $product->pivot->quantity }}</div>
                                         <div class="product-section-image">
                                            <img width="100" height="100" src="{{ productImage($product->image) }}" alt="product" class="active" id="currentImage">
                                        </div>
                                    </li>                                    
                                @endforeach
                            </ul>
